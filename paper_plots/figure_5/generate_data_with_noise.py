...
CUM_NOISE_MAGNITUDE = 5.0e7
RAND_NOISE_MAGNITUDE = 2.0e8
HF_RAND_NOISE_MAGNITUDE = 1.0e8
...
def main():
    ...
    for duration in DURATIONS:
        ...
        for i, seed in zip(range(len(SEEDS)), SEEDS):
            ...
            add_noise(CUM_NOISE_MAGNITUDE, RAND_NOISE_MAGNITUDE, HF_RAND_NOISE_MAGNITUDE, seed, noisy_in_path, noisy_out_path)
